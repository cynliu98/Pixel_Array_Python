...
We analyze the effectiveness of PASS by using it to produce steady states for (number) different partial differential equations. In \cref{sec:homog_heat} we analyze the heat equation. In \cref{sec:Fisher} we test on the Fisher equation. Then, in \cref{sec:WJ}, we examine the Benjamin-Bona-Mohany equation..
