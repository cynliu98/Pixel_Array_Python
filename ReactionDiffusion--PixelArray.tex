...
To apply the PASS method, we need to convert the reaction-diffusion equation \eqref{Reaction-Diffusion Equation} with $u_t = 0$ to a linear equation\todo{In general, finite differences doesn't give linear equations, right?}. This is done using finite differences, which uses secant lines to approximate derivatives. For instance,
