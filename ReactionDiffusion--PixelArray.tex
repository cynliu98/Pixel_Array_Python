...
\todo[inline,author=David]{Somewhere say that the tensors we will multiply have, in each entry, the solutions to the local equation there. And then use this to transition into the next paragraph, or combine them.}
